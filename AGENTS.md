# ArbWethUsdcMomentumStrategy - Agent Guide

> AI coding agent context for the `arb_weth_usdc_momentum` strategy.

## Overview

- **Template:** ta_swap
- **Chain:** arbitrum
- **Class:** `ArbWethUsdcMomentumStrategy` in `strategy.py`
- **Config:** `config.json`
